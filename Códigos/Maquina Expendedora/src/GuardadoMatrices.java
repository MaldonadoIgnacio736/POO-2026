...
public class GuardadoMatrices {
	...
	public GuardadoMatrices() {
		
	}
	
	
	public ArrayList<Producto> crearArrayList() {
		ArrayList<Producto> productos = new ArrayList<>();
		
		for(int i = 0; i< p.length;i++) {
			Producto producto = new Producto(p[i][0],p[i][1],p[i][2],p[i][3],p[i][4]);
